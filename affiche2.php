...
$a = $_POST['nom'];
$requete="SELECT a.ID, a.ID_race, E.Nom_race, a.Naissance, a.Sexe, a.Pseudo, a.Commentaire FROM animaux as a INNER JOIN especes as E on a.ID_race = E.ID WHERE a.Pseudo = '$a'";
...
echo "<td><a href='modify.php?Pseudo=".$enreg['Pseudo']."&Commentaire=".$enreg['Commentaire']."&Sexe=".$enreg['Sexe']."'>Modifier</a></td>";
?>
